...
describe('edit organizational', () => {
    it('testing edit organizational', () => {
        ...
        cy.get('body > div.backgroundLayout.pb-5.pt-5 > div > form > div.mb-3 > div > div.ck.ck-editor__main > div > p').clear()
