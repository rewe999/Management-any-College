        ...
        <table class="table">
            ...
            @foreach($persons as $person)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-success"><a href="{{route('scientific.index',$person->id)}}" class="text-white">Edytuj</a></button>
                    </td>
                    <td>
                        <button class="btn btn-success"><a href="{{route('didactic.index',$person->id)}}" class="text-white">Edytuj</a></button>
                    </td>
                    <td>
                        <button class="btn btn-success"><a href="{{route('organizational.index',$person->id)}}" class="text-white">Edytuj</a></button>
                    </td>
                    <td>
